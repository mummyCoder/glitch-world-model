...
def build_project_state(meta: CacheMetadata, root: Path) -> str:
    blocker = (
        "fresh v3 approval plus validated Kaggle CUDA/resume artifact set"
...
- Current v3 kernel request fingerprint:
  `47107246ea537fce9c435717301b12c0408f296b34567602f6408b77a5d856c9`.
...
- Approve the v3 Gate 5 package and run exactly one CUDA smoke/resume attempt.
