...
| 5 | partial | package, hardened validator, CPU resume smokes, ready private dataset | fresh v4 approval plus validated Kaggle CUDA/resume artifact set | resolve blocker and rerun approved CUDA smoke |
...
- Current v4 kernel request fingerprint:
