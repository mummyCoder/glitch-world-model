...
| 5 | partial | package, hardened validator, CPU resume smokes, ready private dataset | resolved HTTP 409 conflict plus validated Kaggle CUDA/resume artifact set | resolve blocker and rerun approved CUDA smoke |
