...
| 5 | partial | package, hardened validator, CPU resume smokes, ready private dataset | fresh approval plus validated Kaggle CUDA/resume artifact set | resolve blocker and rerun approved CUDA smoke |
...
- Corrected kernel request fingerprint:
